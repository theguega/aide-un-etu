      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-gray-600">
            Connectez-vous avec votre compte étudiant pour accéder à la plateforme d'entraide
          </p>
        </div>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow-sm border border-gray-200 sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6 border-t border-gray-200 pt-6">
            <div className="text-xs text-gray-500 text-center space-y-2">
              <p>
                🌱 <strong>Plateforme éco-responsable</strong> : connexion optimisée pour réduire l'impact environnemental
              </p>
              <p>
                ♿ <strong>Accessible à tous</strong> : interface conçue pour être utilisable par tous les étudiants
              </p>
            </div>
          </div>
